...
from kwim_api.freshness import _to_dt
from kwim_api.gate import Gate
from kwim_api.routers.common import _enrich_facts
from kwim_api.routers.knowledge import knowledge_query as _knowledge_query_handler
from kwim_api.routers.knowledge import knowledge_reaffirm as _knowledge_reaffirm_handler
...
async def test_tombstone_supersede_end_to_end():
    ...
    fk = _FakeFalkor(facts=[{
        ...
        "status": "current",
        "created_at": str(int(datetime.now(UTC).timestamp() * 1000)),
