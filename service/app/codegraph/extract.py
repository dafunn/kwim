...
Run:
  python -m app.codegraph.extract --team <team> --repo <name> --path <checkout> [--no-embed]
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(prog="app.codegraph.extract", description="KWIM code-graph extractor")
