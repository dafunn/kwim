...
_T1 = datetime.datetime(2026, 6, 11, 10, 0, 0, tzinfo=datetime.timezone.utc)
_T2 = datetime.datetime(2026, 6, 11, 11, 0, 0, tzinfo=datetime.timezone.utc)
...
def test_episodic_limit_bounds(episodic):
    cli, _ = episodic
    from app.main import _EPISODIC_MAX_LIMIT
