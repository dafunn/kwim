...
Covers the four pieces that make a free-text subject retrievable:
  ...
  - app.backfill_embeddings      - facts committed without a vector get one, in place
...
# ---------------------------------------------------------------------------
# app.backfill_embeddings - plan / execute
# ---------------------------------------------------------------------------
...
async def test_plan_backfill_separates_blank_statements():
    from app.backfill_embeddings import plan_backfill
...
async def test_execute_backfill_embeds_and_counts():
    from app.backfill_embeddings import execute_backfill
...
async def test_backfill_team_dry_run_writes_nothing():
    from app.backfill_embeddings import backfill_team
